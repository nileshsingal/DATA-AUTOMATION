from aws_cdk import (aws_iam as mm,
    aws_lambda as lb,
    aws_s3 as s3,
...
class S3LambdaStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, construct_id: str, **kwargs) -> None:
        ...
        function = lb.Function(self, "lambda_function",
                                    ...
                                    role = mm.Role.from_role_arn(self, "Role", "arn:aws:iam::919238404395:role/triggerrole",mutable=False))
        # create s3 bucket
        bucket = s3.Bucket(self,"mybucket", bucket_name="mydemoobuckett420",public_read_access=True)
